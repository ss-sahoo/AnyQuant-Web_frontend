...
// import { createAccount, sendOtpEmail } from "@/app/AllApiCalls"
...
//   //     router.push("/home")
//   //   } else {
//   //     // Simulate signup flow - redirect to verification
//   //     router.push("/auth/verify")
//   //   }
//   // }
...
//             activeTab === "login" ? "bg-[#9d9d9d] text-white" : "bg-white text-black"
//           }`}
...
//         <button
//           className={`flex-1 py-4 text-center font-medium ${
//             activeTab === "signup" ? "bg-[#9d9d9d] text-white" : "bg-white text-black"
//           }`}
