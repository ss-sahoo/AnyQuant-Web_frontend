...
// reset". The dropdown only exposes the four it acts on.
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center p-4 border-b border-gray-200">
        <h2 className="text-lg font-medium text-black">Cumulative Volume Delta Settings</h2>
      ...
      <div className="p-4 overflow-y-auto flex-1">
        <div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label
                htmlFor="cvd-reset-period"
                className="block text-sm font-medium text-gray-700 mb-2"
              >
                Reset Period
              </Label>
              <Select value={resetPeriod} onValueChange={setResetPeriod}>
                <SelectTrigger id="cvd-reset-period" className="w-full border border-gray-300 text-black bg-white">
